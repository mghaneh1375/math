...
(function ($) {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                if (typeof column.fieldIndex !== "undefined") {
                    ...
                    that.header.formatters[column.fieldIndex] =
                        column.formatter;
                    that.header.events[column.fieldIndex] = column.events;
                    that.header.sorters[column.fieldIndex] = column.sorter;
                    that.header.sortNames[column.fieldIndex] = column.sortName;
                    that.header.cellStyles[column.fieldIndex] =
                        column.cellStyle;
        ...
        this.$container
            ...
            .on("click", ".th-inner", function (event) {
                ...
                if (that.options.detailView) {
                    if (
                        target.closest(".bootstrap-table")[0] !==
                        that.$container[0]
                    )
                        return false;
                }
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        html = [
            sprintf(
                '<div class="columns columns-%s btn-group">',
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf(
                    '<input id="searchInTable" placeholder="جست و جو" class="form-control' +
            ...
            $search
                .off("keyup drop blur change")
                .on("keyup drop blur change", function (event) {
            ...
            this.data = s
                ? $.grep(this.data, function (item, i) {
                      for (var j = 0; j < that.header.fields.length; j++) {
                          ...
                          var column =
                              that.columns[getFieldIndex(that.columns, key)];
                          var value;
    ...
    BootstrapTable.prototype.updateByUniqueId = function (params) {
        ...
        $.each(allParams, function (i, params) {
            ...
            rowId = $.inArray(
                that.getRowByUniqueId(params.id),
                that.options.data
            );
